...
| Команда | Описание |
|--------|----------|
| `notes add <ноутбук>` | Создать заметку в ноутбуке. Создаётся файл `notes/<ноутбук>/N.md` (N — автоинкремент), открывается vim. Первая строка — заголовок, остальное — текст. |
...
- Python 3.10+
- Для `add`: в системе должен быть редактор (по умолчанию используется `vim`, можно задать `EDITOR`).
